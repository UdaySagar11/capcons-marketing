...
export const OurMissionSections = () => {
  return (
    <div className="bg-black -mt-28">
      <div className="relative bg-white px-4 md:px-48 py-28 pb-12 rounded-t-[30px] md:rounded-t-[50px]">
        <div className="top-0 left-0 absolute w-[140px] md:w-[240px] h-[150px] md:h-[250px] container">
          <Image
        ...
        <div className="w-full container">
          <div className="flex flex-col gap-4">
            <div className="flex md:flex-row flex-col md:justify-between gap-6 mt-[60px] md:mt-0 max-sm:pl-10">
              <MissionButton />
            </div>
            <p className="text-[#2E134D] text-sm md:text-xl">
